...
- **The other lenses are previewed, not just listed.** At the foot of the Overview each one is a card
  ...
  nothing until you open it is a button wearing a chart's clothes. Opening one is an ordinary push —
  a container transform was tried and removed, see [`docs/DECISIONS.md`](docs/DECISIONS.md).
